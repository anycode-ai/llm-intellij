...
class LlmSettingsComponent {
    ...
    init {
        ...
        server = JBTextField("http://52.90.150.209:11434/api/generate")
        modelSectionPanel.add(serverLabel)
        modelSectionPanel.add(server)
        modelLabel = JBLabel("Model name")
        model = JBTextField("deepseek-coder:33b-base")
        ...
        tokensToClear = JBTextField("<|endoftext|>,<｜fim▁begin｜>,<｜fim▁hole｜>,<｜fim▁end｜>")
